...
class StreamSortingService {
    ...
    private fun Comparator<Stream>.then(other: Comparator<Stream>): Comparator<Stream> {
        return Comparator { a, b ->
            val res = this.compare(a, b)
            if (res != 0) res else other.compare(a, b)
        }
    }
